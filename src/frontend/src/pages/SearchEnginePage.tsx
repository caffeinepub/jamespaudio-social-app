...
export default function SearchEnginePage() {
  ...
  const shouldEnableSearch =
    activeTab !== "websearch" && submittedSearch !== "";
    ...
    try {
      ...
      if (/^[\d\s+\-*/().]+$/.test(cleanExpr)) {
        ...
        const mathResult = {
          ...
          explanation:
            "Basic arithmetic calculation performed using standard order of operations (Parentheses, Exponents, Multiplication/Division, Addition/Subtraction).",
        };

        speakResult(
          `Okay, I can help with that. ${cleanExpr} equals ${result}`,
        );
      ...
      if (cleanExpr.includes("sqrt") || cleanExpr.includes("√")) {
        ...
        if (match) {
          const num = Number.parseInt(match[1] || match[2]);
          ...
          speakResult(
            `The square root of ${num} is approximately ${result.toFixed(2)}`,
          );
      ...
      <div className="container max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="text-center space-y-4 py-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Search across apps, users, music, videos, movies, and solve complex
            math problems with voice support and AI voice responses
          </p>
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="lg"
                  disabled={isLoading || webSearch.isLoading}
                >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {isSpeaking
                        ? "Speaking..."
                        : "Math results spoken aloud (toggle in Settings)"}
                    </p>
                  </div>
                  {isSpeaking && (
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <Card className="border-green-500/50 bg-green-500/5">
                  <CardHeader>
                    <div className="flex items-center gap-2">
                      ...
                      <CardTitle>
                        Advanced Math Solution with AI Voice
                      </CardTitle>
                      {isSpeaking && (
              ...
              {isLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {searchResults.results.map((result, _rIdx) => (
                      <Card
                      ...
                      >
                        <CardHeader>
                          <div className="flex items-start gap-3">
                            <Avatar>
                              <AvatarImage
                                src={result.profilePicture.url || undefined}
                              />
                              <AvatarFallback>
                        ...
                        <CardContent>
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            <span>
                              {Number(result.followerCount)} followers
                            </span>
                            <span>
                              {Number(result.followingCount)} following
                            </span>
                          </div>
                        </CardContent>
                      </Card>
                  ...
                  <CardContent className="py-12 text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground max-w-md mx-auto">
                        I currently support <strong>math calculations</strong>{" "}
                        and <strong>limited on-device search</strong> for users.
                        Try a math problem like "50 * 50" or search for users by
                        name.
                      </p>
                    </div>
                    <div className="pt-4">
                      <p className="text-xs text-muted-foreground">
                        Tip: Use voice search or browse trending searches and
                        math examples above
                      </p>
                    </div>
                  </CardContent>
            ...
            <TabsContent value="math" className="space-y-4 mt-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold">
                  Advanced Math Computation with AI Voice
                </h3>
                {isSpeaking && (
                  <Volume2 className="h-5 w-5 text-green-500 animate-pulse" />
                )}
              ...
              {mathResult ? (
                <Card className="border-green-500/50">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="bg-muted p-3 rounded-lg">
                      <p className="text-sm">
                        <strong>Explanation:</strong> {mathResult.explanation}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="py-12 text-center space-y-4">
                    ...
                    <div>
                      <p className="text-muted-foreground mb-2">
                        {submittedSearch
                          ? `Unable to solve: "${submittedSearch}"`
                          : "Enter a math problem to solve"}
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Advanced solver supports: arithmetic, algebra, quadratic
                        equations, sequences, geometry, statistics, and more
                      </p>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="user" className="space-y-4 mt-6">
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {searchResults.results.map((result, _rIdx) => (
                    <Card key={result.userId.toString()}>
                      <CardHeader>
                        <div className="flex items-start gap-3">
                          <Avatar>
                            <AvatarImage
                ...
                <CardContent className="space-y-6">
                  {webSearch.isLoading ? (
                    ...
                    <div className="bg-background/50 p-6 rounded-lg space-y-4">
                      <p className="text-muted-foreground">
                        Enter a search term above to search the web for news,
                        articles, and real-time information.
                      </p>
                      ...
                      <div className="space-y-3">
                        ...
                        <ul className="text-sm text-muted-foreground space-y-2">
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              Search across millions of web pages and news
                              sources
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-blue-500 mt-0.5">•</span>
                            <span>
                              Real-time information and breaking news updates
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-blue-500 mt-0.5">•</span>
                  ...
                  <p className="text-xs text-center text-muted-foreground">
                    In the meantime, try our advanced math solver or search for
                    users, apps, and content
                  </p>
                </CardContent>
              </Card>
            </TabsContent>

  ...
  return (
    <div className="h-full flex flex-col">
      <div className="relative h-48 bg-gradient-to-br from-purple-600 via-blue-600 to-pink-600 overflow-hidden">
        <img
          src="/assets/generated/live-tv-channels.dim_600x400.png"
          alt="Live TV"
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div>
            ...
            <p className="text-white/90">
              Watch simulated TV channels - Entertainment, News & Music
            </p>
          </div>
        </div>
      </div>
                  ...
                  >
                    <CardHeader className="p-0">
                      <div className="relative aspect-video overflow-hidden rounded-t-lg">
                        ...
                        />
                        <Badge
                          className={`absolute top-2 right-2 ${getCategoryColor(channel.category)}`}
                        >
                          {channel.category}
                        </Badge>
                      </div>

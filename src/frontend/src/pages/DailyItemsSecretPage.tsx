...
import {
  useClaimDailyItemsSecret,
  useGetLastClaimedMysteryItem,
  useIsMysteryItemClaimAvailable,
...
export default function DailyItemsSecretPage() {
  ...
  const handleOpenBox = async () => {
    if (!canClaim) {
      toast.error(
        "You have already claimed your daily mystery item. Come back tomorrow!",
      );
      return;
    }

    ...
    <div className="h-full flex flex-col">
      <div className="relative h-48 bg-gradient-to-br from-robux-primary via-robux-secondary to-robux-accent overflow-hidden">
        <img
          ...
          alt="Robux"
          className="absolute right-10 top-10 h-24 w-24 opacity-30 animate-pulse"
        />
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div>
            ...
            <p className="text-white/90">
              Fun pretend code generator (Not real!)
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="container mx-auto px-4 py-6 space-y-6">
            <Card className="border-warning bg-warning/5">
              <CardContent className="pt-6">
                <p className="text-sm text-center font-semibold">
                  ⚠️ This is a fun simulator only! These codes are not real and
                  cannot be used in Roblox.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create a fun fake Robux code for entertainment
                </CardDescription>
              </CardHeader>
                ...
                {generatedCode && (
                  <div className="space-y-3 p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-xs text-center text-muted-foreground">
                      Remember: This is just for fun and cannot be used in
                      Roblox!
                    </p>
                  </div>
                )}

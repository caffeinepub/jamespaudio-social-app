      ...
      const mockResults: WebSearchResult[] = [
        {
          ...
          snippet:
            "Web Search Ultra is currently in development. This feature will provide real-time web search results from across the internet.",
          url: "#",
        },
        {
          title: "Coming Soon",
          snippet:
            "Advanced web search capabilities with filtering, relevance ranking, and rich previews will be available soon.",
          url: "#",
        },
      ];
